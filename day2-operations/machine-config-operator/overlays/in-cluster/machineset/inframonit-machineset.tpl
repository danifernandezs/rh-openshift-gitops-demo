...
spec:
  ...
  selector:
    matchLabels:
      ...
      machine.openshift.io/cluster-api-machineset: ${infraName}-inframonit-eu-west-1a
  template:
    metadata:
      labels:
        machine.openshift.io/cluster-api-cluster: ${infraName}
    ...
    spec:
      ...
      providerSpec:
        value:
          userDataSecret:
            name: inframonit-user-data-managed
          placement:
...
spec:
  ...
  selector:
    matchLabels:
      machine.openshift.io/cluster-api-cluster: ${infraName}
      machine.openshift.io/cluster-api-machineset: ${infraName}-inframonit-eu-west-1b
  template:
    metadata:
      labels:
        machine.openshift.io/cluster-api-cluster: ${infraName}
...
spec:
  ...
  selector:
    matchLabels:
      machine.openshift.io/cluster-api-cluster: ${infraName}
      machine.openshift.io/cluster-api-machineset: ${infraName}-inframonit-eu-west-1c
  template:
    metadata:
      labels:
        machine.openshift.io/cluster-api-cluster: ${infraName}
